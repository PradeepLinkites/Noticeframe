...
// import {Platform, Alert, StyleSheet, Text, View, Button, SafeAreaView, Image, ScrollView, Dimensions } from 'react-native'
...
// export default class ExportSetting extends React.Component {
//   constructor(props) {
//     super(props)
//     this.state = {
//       value: '',
...
//     const route = get(state, 'routeName', '')  === 'ExportSetting' ? 'Export Settings' : ''
//     return (
...
//             routeKey={'ExportSetting'} 
//           />
//           <View style={styles.topContainer}>
//             <View style={styles.firstView}>
//               <Text style={styles.text}>Export to Calender</Text>
